...
const EditVehicleModal: React.FC<Props> = ({ open, vehicle, onClose, onSaved }) => {
  const { form, setField, addPhotoFile, removePhotoAt, updateVehicle, submitting } = useVehicleForm(vehicle);
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded shadow p-6 w-full max-w-3xl">
        <h3 className="text-lg font-semibold">Éditer véhicule</h3>
