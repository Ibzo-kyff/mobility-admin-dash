  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-2xl font-black text-black tracking-tight">Gestion des Marques</h1>
          <p className="text-black font-bold text-xs uppercase tracking-widest mt-1">Consultez les marques et leurs véhicules associés</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
              ...
              >
                <div className="w-20 h-20 bg-gray-50 rounded-xl flex items-center justify-center p-3 relative overflow-hidden">
                  {fullLogoUrl ? (
                    ...
                    <FontAwesomeIcon icon={faCar} className="text-3xl text-black group-hover:text-orange-400 transition-colors" />
                  )}
                </div>
                <div className="text-center w-full">
                  <h3 className="font-bold text-black truncate group-hover:text-orange-500 transition-colors">{marque.name}</h3>
                  <div className="text-[10px] text-black font-bold uppercase mt-1 flex items-center justify-center gap-1 group-hover:text-orange-400 transition-colors">
          ...
          {filteredMarques.length === 0 && (
            <div className="col-span-full py-12 text-center text-black font-medium bg-gray-50 rounded-2xl border border-dashed border-gray-200">
